...
export const AIRPORTS: Airport[] = [
  ...
  { iata: "APA", icao: "KAPA", city: "Denver", name: "Centennial", lat: 39.57, lon: -104.85, tz: "MT" },
  { iata: "DEN", icao: "KDEN", city: "Denver", name: "Denver Intl.", lat: 39.86, lon: -104.67, tz: "MT" },
  ...
  { iata: "AUS", icao: "KAUS", city: "Austin", name: "Austin-Bergstrom Intl.", lat: 30.19, lon: -97.67, tz: "CT" },
  { iata: "EDC", icao: "KEDC", city: "Austin", name: "Austin Executive", lat: 30.40, lon: -97.57, tz: "CT" },
  { iata: "SAT", icao: "KSAT", city: "San Antonio", name: "San Antonio Intl.", lat: 29.53, lon: -98.47, tz: "CT" },
  { iata: "SSF", icao: "KSSF", city: "San Antonio", name: "Stinson Municipal", lat: 29.34, lon: -98.47, tz: "CT" },
  { iata: "BNA", icao: "KBNA", city: "Nashville", name: "Nashville Intl.", lat: 36.12, lon: -86.68, tz: "CT" },
  { iata: "JWN", icao: "KJWN", city: "Nashville", name: "John C. Tune", lat: 36.18, lon: -86.89, tz: "CT" },
  { iata: "FCM", icao: "KFCM", city: "Minneapolis", name: "Flying Cloud", lat: 44.83, lon: -93.46, tz: "CT" },
  { iata: "MSP", icao: "KMSP", city: "Minneapolis", name: "Minneapolis-St. Paul Intl.", lat: 44.88, lon: -93.22, tz: "CT" },
  ...
  { iata: "FXE", icao: "KFXE", city: "Fort Lauderdale", name: "Fort Lauderdale Exec.", lat: 26.20, lon: -80.17, tz: "ET" },
  { iata: "FLL", icao: "KFLL", city: "Fort Lauderdale", name: "Fort Lauderdale-Hollywood Intl.", lat: 26.07, lon: -80.15, tz: "ET" },
  { iata: "APF", icao: "KAPF", city: "Naples", name: "Naples", lat: 26.15, lon: -81.78, tz: "ET" },
  { iata: "ORL", icao: "KORL", city: "Orlando", name: "Orlando Executive", lat: 28.55, lon: -81.33, tz: "ET" },
  { iata: "MCO", icao: "KMCO", city: "Orlando", name: "Orlando Intl.", lat: 28.43, lon: -81.31, tz: "ET" },
  { iata: "TPA", icao: "KTPA", city: "Tampa", name: "Tampa Intl.", lat: 27.98, lon: -82.53, tz: "ET" },
  { iata: "TPF", icao: "KTPF", city: "Tampa", name: "Peter O. Knight", lat: 27.92, lon: -82.45, tz: "ET" },
